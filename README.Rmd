...
* [sets](https://cran.r-project.org/web/packages/sets/index.html) - The **sets** package uses S3 to define some symbolic representaton of mathematical sets,
...
* [BaseSet](https://github.com/llrs/BaseSet) - The **BaseSet** package focuses on storing and analysing
