...
test_that("inherited_methods",{
  ...
  expect_equal(FuzzyTuple$new("a",0.1)$max,numeric(0))
  expect_equal(FuzzyTuple$new("a",0.1)$min,numeric(0))
  expect_equal(FuzzyTuple$new("a",0.1)$upper,numeric(0))
  expect_equal(FuzzyTuple$new("a",0.1)$lower,numeric(0))
  ...
  expect_true(FuzzyTuple$new(1,0.1,2,0.3,3,0.9)$liesInSet(1))
  expect_false(FuzzyTuple$new(1,0.1,2,0.3,3,0.9)$liesInSet(5))
})
