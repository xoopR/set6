...
test_that("inherited_methods",{
  ...
  expect_equal(FuzzySet$new("a",0.1)$max,numeric(0))
  expect_equal(FuzzySet$new("a",0.1)$min,numeric(0))
  expect_equal(FuzzySet$new("a",0.1)$upper,numeric(0))
  expect_equal(FuzzySet$new("a",0.1)$lower,numeric(0))
