...
test_that("inherited_methods",{
  ...
  # expect_equal(Set$new()$upper,NA)
  # expect_equal(Set$new()$lower,NA)
  # expect_equal(Set$new()$max,NaN)
  # expect_equal(Set$new()$min,NaN)
  # expect_equal(Set$new("a",2)$max, NaN)
  # expect_equal(Set$new("a",2)$min, NaN)
  # expect_equal(Set$new("a",2)$upper, 2)
  # expect_equal(Set$new("a",2)$lower, "a")
...
test_that("elements",{
  ...
  expect_equal(Set$new(1:10)$elements, as.list(1:10))
  expect_equal(Set$new(list(1))$elements, list(1))
