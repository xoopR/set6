...
test_that("as.FuzzyTuple",{
  ...
  expect_message(expect_equal(as.FuzzyTuple(Interval$new()), Interval$new()), "Interval cannot be")
  expect_message(expect_equal(as.FuzzyTuple(ConditionalSet$new(function(x) TRUE)),ConditionalSet$new(function(x) TRUE)), "ConditionalSet cannot be")
})
