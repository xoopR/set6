...
test_that("inherited_methods",{
  ...
  expect_equal(Tuple$new("a",2)$max,numeric(0))
  expect_equal(Tuple$new("a",1)$min,numeric(0))
  expect_equal(Tuple$new("a",1)$upper,numeric(0))
  expect_equal(Tuple$new("a",1)$lower,numeric(0))
