...
test_that("as.FuzzySet",{
  ...
  expect_message(expect_equal(as.FuzzySet(Interval$new()), Interval$new()), "Interval cannot be")
  expect_message(expect_equal(as.FuzzySet(ConditionalSet$new(function(x) TRUE)),ConditionalSet$new(function(x) TRUE)), "ConditionalSet cannot be")
})
